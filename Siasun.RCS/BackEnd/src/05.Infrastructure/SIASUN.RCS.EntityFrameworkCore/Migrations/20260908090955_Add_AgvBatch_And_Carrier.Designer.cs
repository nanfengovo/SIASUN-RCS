...
namespace SIASUN.RCS.Migrations
{
    ...
    [Migration("20260908090955_Add_AgvBatch_And_Carrier")]
    partial class Add_AgvBatch_And_Carrier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIASUN.RCS.Auditing.AuditLogFilterRule", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("RuleType", "IsEnabled", "Direction");

                    b.ToTable("AppAuditLogFilterRules", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Auditing.EntityAuditRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEntityAuditRules", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Batches.AgvBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIASUN.RCS.Locations.LocationLock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LeaseExpirationTime");
                    ...
                    b.ToTable("AppLocationLocks", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Locations.LocationMap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PreDockStationCode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.ToTable("AppLocationMaps", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Locations.LocationPlcConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InterlockReadyTag")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.Property<string>("MaterialPresenceTag")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.ToTable("AppLocationPlcConfigs", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Logs.OperatorLogs.OperationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIASUN.RCS.Monitor.SystemEventLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSystemEventLogs", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppOutboxMessages", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Tasks.AgvTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ActiveLeg")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("AssignedVehicleCode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<string>("OptionCodeSchemaCode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<int?>("OptionCodeSchemaVersion")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WaitingEvent")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.ToTable("AppAgvTasks", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Tasks.Profiling.TaskStepProfiling", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Subsystem");

                    b.HasIndex("TaskCode");

                    b.HasIndex("Subsystem", "DurationMs");

                    b.HasIndex("TaskCode", "StartTime");

                    b.ToTable("AppTaskStepProfilings", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Tasks.TaskSerialMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTaskSerialMappings", (string)null);
                });

            modelBuilder.Entity("SIASUN.RCS.Vehicles.AgvVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CurrentTaskCode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.ToTable("AppAgvVehicles", (string)null);
                });
