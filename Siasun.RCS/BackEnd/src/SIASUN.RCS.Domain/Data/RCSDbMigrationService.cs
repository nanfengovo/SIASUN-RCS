...
public class RCSDbMigrationService : ITransientDependency
{
    ...
    private readonly IEnumerable<IRCSDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public RCSDbMigrationService(
        IDataSeeder dataSeeder,
        ITenantRepository tenantRepository,
        ICurrentTenant currentTenant,
        IEnumerable<IRCSDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<RCSDbMigrationService>.Instance;
    }
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName,
                RCSConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName,
                RCSConsts.AdminPasswordDefaultValue)
        );
    }
